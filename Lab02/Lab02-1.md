...
### Objectives
 ...
 - Explore the Python Interpreter
 - Learn basic editing
 - Investigate different modes of interaction with the Python interpreter
...
#### Python Interpreter
 ...
 1. In your Anaconda Qt Console or Shell, start a Python interpreter.
 2. How do you terminate a Python interpreter `exit()`?
 3. Explore the Python help system by `help()`, try `help(random)`.
 4. How do you enter and exit interactive help? (hint: try `Esc` `:` `q` to exit)
...
#### Use Linux and Python on Windows 11 (optional)
...
#### Supercharge your terminal (optional)
  1. You can install tools such as `Zoxide`, `Eza`, `FZF`, and `LazyGit` to make your terminal much easier to use. 
  2. How to do it? Please figure out by yourself with the support from AI. 
