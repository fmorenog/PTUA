...
You can repurpose some of the code you used in [Exercise Lab07-1], but it needs to be refactored using object oriented design.

### Submission

1. In your branch `Lab07`, uploads your `adjacency.py` file
2. Submit a pull request

[gal file]: Lab07-1.gal
[Exercise Lab07-1]: Lab07-1.md
